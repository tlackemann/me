...
class Instagram {
  ...
  public function __construct($config = array()) {
  	$config = array(
  		'apiKey' => TomConfig::INSTAGRAM_API_KEY,
  		'apiSecret' => TomConfig::INSTAGRAM_API_SECRET,
  		'apiCallback' => TomConfig::INSTAGRAM_API_CALLBACK,
  		'OAuthToken' => TomConfig::INSTAGRAM_OAUTH_TOKEN
	);
    if (true === is_array($config)) {
      ...
      if (isset($config['OAuthToken']))
      {
      	$this->setAccessToken($config['OAuthToken']);
      }
